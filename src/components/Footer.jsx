        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <Link to="/" className="text-3xl font-bold text-white block mb-6">
              Immigration
              <span className="text-[var(--accent-blue)]">Agency</span>
            </Link>
            <p className="text-gray-400 mb-8 leading-relaxed">
              We are a leading immigration consultancy firm providing expert
              guidance for skilled migration, student visas, and business
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[var(--accent-blue)] hover:border-[var(--accent-blue)] transition-all cursor-pointer transform hover:-translate-y-1"
              >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  to="/about"
                  className="text-gray-400 hover:text-[var(--accent-blue)] transition-colors flex items-center gap-2"
                >
            ...
            <ul className="space-y-6">
              <li className="flex items-start gap-4 group">
                ...
                <span className="text-gray-400 group-hover:text-white transition-colors">
                  03, Main Street, Saraiyady, Point Pedro, Jaffna.
                </span>
              </li>
