        ...
        <section className="py-20 bg-white">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-[var(--accent-blue)] font-bold tracking-wider uppercase mb-3 text-sm">Destinations</h2>
                    <h3 className="text-3xl md:text-5xl font-bold text-[var(--primary)] mb-4">Countries We Support</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {countries.map((country, index) => (
                        <div key={index} className="relative h-64 rounded-xl overflow-hidden shadow-lg group cursor-pointer bg-gray-200">
                            {/* Background Image */}
                            <img
                                src={country.image}
                                alt={country.name}
                            ...
                            <div className="absolute inset-0 flex flex-col justify-end p-6 text-white z-20">
                                <h4 className="text-2xl font-bold mb-2">{country.name} Visas</h4>
